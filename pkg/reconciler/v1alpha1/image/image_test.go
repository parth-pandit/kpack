...
func testImageReconciler(t *testing.T, when spec.G, it spec.S) {
	...
	when("Reconcile", func() {
		it.Pend("updates observed generation after processing an update", func() {
		...
		when("reconciling builds", func() {
				...
				rt.Test(rtesting.TableRow{
					...
					WantCreates: []runtime.Object{
						&v1alpha1.Build{
							...
							Spec: v1alpha1.BuildSpec{
								Tags:           []string{image.Spec.Tag},
								Builder:        customBuilder.BuildBuilderSpec(),
								ServiceAccount: image.Spec.ServiceAccount,
								Source: v1alpha1.SourceConfig{
									Git: &v1alpha1.Git{
										URL:      sourceResolver.Status.Source.Git.URL,
			...
			it("schedules a build with a custom custom builder", func() {
				image.Spec.Builder = corev1.ObjectReference{
				...
				rt.Test(rtesting.TableRow{
					...
					WantCreates: []runtime.Object{
						&v1alpha1.Build{
							...
							Spec: v1alpha1.BuildSpec{
								Tags:           []string{image.Spec.Tag},
								Builder:        customClusterBuilder.BuildBuilderSpec(),
								ServiceAccount: image.Spec.ServiceAccount,
								Source: v1alpha1.SourceConfig{
									Git: &v1alpha1.Git{
										URL:      sourceResolver.Status.Source.Git.URL,
